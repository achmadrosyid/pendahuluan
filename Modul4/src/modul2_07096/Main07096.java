...
import View.GUI07096;

public class Main07096 {

    private static AdminController07096 admin = new AdminController07096();
    private static Scanner input = new Scanner(System.in);
    private static PraktikanController07096 praktikan = new PraktikanController07096();

    public static void main(String[] args) {
        GUI07096 gui = new GUI07096();
...
//        } while (loop != 1);
    ...
    static void loginPraktikan() {
        ...
        if (cek == -1) {
            ...
            System.out.print("NPM : " + praktikan.showDaftarprak(cek).getPraktikan().getNama()
                    ...
                    + "\n Praktikum : " + PraktikumEntity07096.nama[praktikan.showDaftarprak(cek).getIndexPrak()]
                    + "\n IsVerified : ");
    ...
    static void registerPraktikum() {
        ...
        for (int i = 0; i < PraktikumEntity07096.nama.length; i++) {
            System.out.println((i) + " " + PraktikumEntity07096.nama[i]);
        }
    ...
    static void updateIsverified() {
        ...
        String npm = input.next();
        int index = AllObjectModel07096.daftarprakmodel07096.cekData(npm, npm);
