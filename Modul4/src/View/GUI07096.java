...
public class GUI07096 {
    ...
    public GUI07096() {
        ...
        top = new JLabel("Label Rekayasa Perangkat Lunak");
        ...
        check.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (ceklogin == true) {
                    try {
                        allobjctrl07096.admin.dataAslab();
                        allobjctrl07096.admin.login(textnpmlogin.getText(), passwordlogin.getText());
                        String nama = allobjctrl07096.admin.aslabEntity().getNama();
                        JOptionPane.showMessageDialog(null, "Selamat Datang " + nama, "information", JOptionPane.INFORMATION_MESSAGE);
                        AslabGUI07096 asisten = new AslabGUI07096();
                        LogReg.dispose();
                    ...
                    try {
                        allobjctrl07096.praktikan.login(textnpmlogin.getText(), passwordlogin.getText());
                        String nama = allobjctrl07096.praktikan.praktikanEntity().getNama();
                        JOptionPane.showMessageDialog(null, "Selamat Datang " + nama, "information", JOptionPane.INFORMATION_MESSAGE);
                        PraktikanGUI07096 prak = new PraktikanGUI07096();
                        LogReg.dispose();
                    } catch (Exception exception) {
                        JOptionPane.showMessageDialog(null, "NPM atau Password Salah", "information", JOptionPane.INFORMATION_MESSAGE);
                        kosong();
        ...
        reg.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    allobjctrl07096.praktikan.insert(npm, pass, nama, notelp, tgllahir, kelas);
