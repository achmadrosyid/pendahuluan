...
public class AslabGUI07096 {

    private static PraktikanController07096 praktikan = new PraktikanController07096();
    ...
    public AslabGUI07096() {
        ...
        verif.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                int index = AllObjectModel07096.daftarprakmodel07096.cekData(npm, pass);
                allobjctrl07096.admin.updateIsVerified(index,
                        allobjctrl07096.praktikan.showDaftarprak(index).getIndexPrak(),
                        allobjctrl07096.praktikan.showDaftarprak(index).getPraktikan());
        ...
        tabelpraktikan.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                npmtext.setText(allobjctrl07096.praktikan.daftarprak().getValueAt(i, 0).toString());
                passtext.setText(allobjctrl07096.praktikan.daftarprak().getValueAt(i, 1).toString());
            }
        });
    }
}
